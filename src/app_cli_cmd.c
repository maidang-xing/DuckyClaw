/**
 * @file cli_cmd.c
 * @brief Unified CLI implementation for TClaw (config commands only)
 * @version 0.1
 * @date 2026-04-08
...
static void cmd_help(int argc, char *argv[])
{
    ...
    cli_echof_("  %-28s %s", "cfg_set_device_id <id>", "Set TClaw device ID");
...
static void cmd_cfg_show(int argc, char *argv[])
{
    ...
    cli_print_app_cfg_item_("device_id", APP_KV_DEVICE_ID, TCLAW_DEVICE_ID, true);
